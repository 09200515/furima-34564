class OrderDelivery
  ...
  def save
    ...
    Delivery.create(postal_cord: postal_cord, shipping_area_id: shipping_area_id, city: city, phone_number: phone_number,
                    address_line1: address_line1, address_line2: address_line2, order_id: order.id)
  end
end
